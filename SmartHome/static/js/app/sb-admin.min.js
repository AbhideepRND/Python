...
$(function(){
        ...
        $('img').on('click', function(event){
            window.location.href="componentdetails?key="+$(this).attr('key')
        })

        $('input[type=checkbox]').on('change', function(event){
            var json={};
            json['moduleName']=$('#moduleName').text();
            json['pin']=parseInt($(this).attr('identity'));
            json['key']=parseInt($('#moduleName').attr('key'));
            json['pinStatus']=$(this).is(':checked');
            json['error']=null;
            console.log($(this).is(':checked'))
            var payload = requestObject.call(requestObject.methodType.POST,
                    requestObject.appURL.Service['controlModule'], JSON.stringify(json));
            console.log(payload);
        })
})